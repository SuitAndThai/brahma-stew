...
public class Main {
	...
	public static void main(String[] args) {
		final JFrame frame = new JFrame("Personal Record");
		
		// Configure JFrame to terminate application when it is closed
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.setLocationRelativeTo(null);
		
		// By default content pane has BorderLayout as its layout manager
		...
		browserFrame.setLocationRelativeTo(frame);
